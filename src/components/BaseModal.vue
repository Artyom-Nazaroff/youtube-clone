<template>
	<div :class="classes" tabindex="-1" @keydown.esc="close" role="dialog">
		<transition appear enter-active-class="ease-out duration-200" enter-from-class="opacity-0"
		...
		<div v-if="isOpen" class="relative bg-white w-full sm:w-2/3 m-8 flex flex-col"
